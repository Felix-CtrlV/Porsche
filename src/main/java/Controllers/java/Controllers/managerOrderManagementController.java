...
public class managerOrderManagementController {
    ...
    public void setDashboardController(Controllers.managerDashboardController dashboardController) {
            ...
            if (rs.next()) {
                ...
                if (carId > 0) {
                    ...
                    if (customizations.isEmpty()) {
                        ...
                        List<Controllers.managerDashboardController.CustomizationItem> dashboardItems = new ArrayList<>();
