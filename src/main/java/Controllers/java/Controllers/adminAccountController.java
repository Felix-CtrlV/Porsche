...
public class adminAccountController {
    ...
    private Controllers.adminDashboardController dashboardController;

    public void setDashboardController(Controllers.adminDashboardController dashboardController) {
